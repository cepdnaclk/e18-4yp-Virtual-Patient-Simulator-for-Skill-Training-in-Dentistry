...
const OtherCharts = ({ onComplete }) => {
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            try {
                const url = `${BASE_URL}examintionQuestions/getAllExaminationQuestionsBySectionName?mainTypeName=${selectedCaseDetails.mainComplaintType}&complaintTypeName=${selectedCaseDetails.caseName}&caseId=${selectedCaseDetails.caseId}&sectionName=RecordPlaqueScore`;
                console.log("url", url);
