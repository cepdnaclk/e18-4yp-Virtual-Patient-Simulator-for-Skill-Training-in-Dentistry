...
import QuestionMessage from "../../../ExaminationQuestions/QuestionMessage";
...
const BlackBoxWithButton = ({unityData, sendMessageToUnity}) => {
    ...
    const [instruction, setInstruction] = useState("EXTRA ORAL VIEW EXAMINATION");
    const [examination, setExamination] = useState("");
    const [questionMessage, setQuestionMessage] = useState("Since Patient looks fit and healthy , please click Enter INTRA ORAL View button to proceed with the rest of the examination."); // New state to hold the question message
   ...
   const forceOptions = [
    ...
    return (
        <div style={boxStyle}>
            <TitleBox instruction={instruction} examination={examination}/>
            ...
            <div style={questionBoxStyle}>
                <div>
                    ...
                    {isSubmitted === true || step === 1 ? (
                        ...
                        <QuestionMessage questionMessage={questionMessage}/>
                        //Press The TOOL TRAY VIEW button to see the dental tools
                    ...
                    {step === 7 && (
                        <div>
                            ...
                            <div
                                style={{display: 'flex', justifyContent: 'center', width: '100%', marginLeft: '500px'}}>
